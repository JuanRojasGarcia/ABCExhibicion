...
GO
PROC_DOCUMENTACION 'zabccat_ventasdetalle','num_totalventa','costo toal de la venta'
GO
PROC_DOCUMENTACION 'zabccat_ventasdetalle','fech_venta','fecha en que se efectuo la venta'
GO
PROC_DOCUMENTACION 'zabccat_ventasdetalle','num_articuloscomprados','cantidad de articulos comprados'
GO
